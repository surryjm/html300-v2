$(function() {
  ...
  // Find the first instance of "template-hook" class in index.html 
  // to insert the data/html
  const container = document.querySelector('.template-hook');

  // Use forEach method to apply the function per element in the JSON array
  employees.forEach(function(el) {
    
    // Create the "div container" to contain each employee card
    const divContainer = document.createElement('div');
    
    // Apply the "container" class to the "div container"
